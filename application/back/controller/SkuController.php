...
use app\back\model\Sku;
use app\back\validate\SkuValidate;
...
class SkuController extends Controller
{
    ...
    public function setAction($id = null)
    {
        ...
        if ($request->isGet()) {
            ...
            $data = Session::get('data') ?: (!is_null($id)?Db::name('sku')->find($id) : []);
